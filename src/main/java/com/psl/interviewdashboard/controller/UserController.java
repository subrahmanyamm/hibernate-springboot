package com.psl.interviewdashboard.controller;
...
public class UserController {
    ...
    public ResponseEntity<User> updateUserPartially(@PathVariable("id") int id, @RequestBody User currentUser) throws Exception{
        User user = userService.findById(id);
        if(user ==null){
            return new ResponseEntity<User>(HttpStatus.NOT_FOUND);
        }
